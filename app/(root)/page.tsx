...
import namanImg from "@/public/Shubham_profile_image.jpg";
        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              Cybersecurity enthusiast focused on web security, threat analysis, and ethical hacking.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"https://github.com/shubhamdhamal"}
                target="_blank"
                className={cn(buttonVariants({ size: "lg" }))}
                aria-label="View Shubham's GitHub profile"
              >
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Shubham Dhamal"
              >
